...
try{
	...
	//driver.findElement(By.xpath("(//div[@class='ctable']/table//tr/td[3][not(contains(text(),'Dual' and contains(text(),'Tandem Lane')))]/../../../../../td[1]/a)[1]")).click()
	
	driver.findElement(By.xpath("(//div[@class='ctable']/table//tr/td[3][contains(text(),'00000012')]/../td//span)[1]")).click()
	
	//driver.findElement(By.xpath("(//span[contains(text(),'View/Edit')])[7]")).click()
